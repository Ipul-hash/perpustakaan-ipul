            ...
            <div class="notice d-flex bg-light-primary rounded border-primary border border-dashed p-6 mb-7">
                ...
                <div class="d-flex flex-stack flex-grow-1">
                    <div class="fw-semibold">
                        <div class="fs-6 text-gray-700">Peminjaman buku yang Anda lakukan akan berstatus <b>Pending</b> terlebih dahulu di menu Riwayat. Silakan kunjungi meja administrasi untuk mengambil buku fisik agar statusnya disetujui (Approved).</div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="flex-lg-row-fluid ms-lg-15">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="tab_informasi" role="tabpanel">
                                    <div class="row mb-7"><label class="col-lg-4 fw-semibold text-muted">Judul Buku</label><div class="col-lg-8"><span class="fw-bold fs-6 text-gray-800" id="info-title"></span></div></div>
                                    <div class="row mb-7"><label class="col-lg-4 fw-semibold text-muted">Penulis</label><div class="col-lg-8"><span class="fw-bold fs-6 text-gray-800" id="info-author"></span></div></div>
                                    <div class="row mb-7"><label class="col-lg-4 fw-semibold text-muted">Penerbit</label><div class="col-lg-8"><span class="fw-bold fs-6 text-gray-800" id="info-publisher"></span></div></div>
                                    <div class="row mb-7"><label class="col-lg-4 fw-semibold text-muted">Tahun Terbit</label><div class="col-lg-8"><span class="fw-bold fs-6 text-gray-800" id="info-year"></span></div></div>
                                    <div class="row mb-7"><label class="col-lg-4 fw-semibold text-muted">ISBN</label><div class="col-lg-8"><span class="fw-bold fs-6 text-gray-800" id="info-isbn"></span></div></div>
                                    <div class="row mb-7"><label class="col-lg-12 fw-semibold text-muted">Deskripsi</label><div class="col-lg-12 mt-2"><span class="fw-semibold fs-6 text-gray-800" id="info-desc"></span></div></div>
                                </div>
        ...
        function renderBooks() {
            ...
            container.innerHTML = filtered.map(b => {
                ...
                const stockBadge = b.stock > 0 
                    ? `<span class="badge badge-light-success fw-bold px-4 py-3">Tersedia</span>`
                ...
                try {
                    ...
                    if (json.success) {
                        ...
                        Swal.fire({
                            ...
                            text: 'Peminjaman buku Anda sedang diproses. Silakan ambil buku di perpustakaan agar disetujui oleh admin/staff.'
                        });
                        fetchBooks();
                    } else {
